                        ...
                        <svg class="icon-icon-keyboard-down">
                          <use xlink:href="#icon-keyboard-down"></use>
                                        ...
                                        <div class="dropdown-menu dropdown-menu--right dropdown-menu--fluid js-dropdown-select"><a class="dropdown-menu__item active" href="#" tabindex="0" data-value="All status"><span class="marker-item"></span> All status</a>
                                            <a class="dropdown-menu__item" href="#" tabindex="0" data-value="Published"><span class="marker-item color-green"></span> Published</a><a class="dropdown-menu__item" href="#" tabindex="0" data-value="Pending"><span class="marker-item color-blue"></span> Pending</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group form-group--inline col-12 col-sm-auto">
                                    <div class="toolbox__status input-group input-group--white input-group--append">
                                        <input class="input input--select" type="text" value="Any rating" data-toggle="dropdown" readonly><span class="input-group__arrow">
                        <svg class="icon-icon-keyboard-down">
                          <use xlink:href="#icon-keyboard-down"></use>
                        </svg></span>
                                        <div class="dropdown-menu dropdown-menu--right dropdown-menu--fluid js-dropdown-select"><a class="dropdown-menu__item active" href="#" tabindex="0" data-value="Any rating">Any rating</a><a class="dropdown-menu__item" href="#" tabindex="0" data-value="1">1</a><a class="dropdown-menu__item" href="#"
                                            tabindex="0" data-value="2">2</a><a class="dropdown-menu__item" href="#" tabindex="0" data-value="3">3</a><a class="dropdown-menu__item" href="#" tabindex="0" data-value="4">4</a><a class="dropdown-menu__item"
                                            href="#" tabindex="0" data-value="5">5</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="toolbox__right col-12 col-lg-auto">
                            <div class="toolbox__right-row row row--xs flex-nowrap">
                                <div class="col-auto ml-auto">
                                    <button class="button-add button-add--blue" data-modal="#addReview"><span class="button-add__icon">
                            ...
                            <thead class="table__header">
                              ...
                              <svg class="icon-icon-checked">
                                <use xlink:href="#icon-checked"></use>
                                    ...
                                    <th class="table__th-sort"><span class="align-middle">Rating</span><span class="sort sort--down"></span>
                                    </th>
                            ...
                            <tbody>
                              ...
                              <svg class="icon-icon-checked">
                                <use xlink:href="#icon-checked"></use>
                                    ...
                                    <td class="table__td text-overflow maxw-260"><span class="text-light-theme">The Series 4 is a significant step</span>
                                    </td>
                                    <td class="table__td">
                                        <div class="rating js-rating-stars" data-rating="5" data-readonly="true"></div>
                                    </td>
                                    <td class="table__td text-nowrap"><span class="text-light-theme">12.07.2018</span>  <span class="text-dark-theme">10:00</span>
                                    </td>
                                    <td class="table__td">
